...
class MainWindow:
    ...
    def run(self):
        ...
        sg.theme(str_theme)
        layout_title_main = [
            sg.Text(emojize(":fleur-de-lis: CreationKit-DialogDocGen :fleur-de-lis:", variant="emoji_type"),
                    font=('Any', 32))]
        layout_title_config = [
            sg.Text(emojize(":hammer_and_wrench:Application Setup", variant="emoji_type"), font=MainWindow.FONT_TITLE2)]
        layout_title_export = [
